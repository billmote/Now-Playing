...
public class APIEventHandler {
    ...
    public void getMovies(final GetMoviesEvent event) {
         ...
         */
        APIBuilder.createApiInstance(mContext, mContext.getString(R.string.movies_url)).getMovies(mContext.getString(R.string.rotten_tomatoes_api_key /* Look in res/values/secret.xml */), event.getPageNumber(), new APIHandler<Movies>(event.getCallNumber()) {
            @Override
